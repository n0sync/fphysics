# Physics & Computer Science Topics
...
* [Heisenberg Uncertainty Principle](https://en.wikipedia.org/wiki/Uncertainty_principle)
...
* [Einstein's Equivalence Principle](https://en.wikipedia.org/wiki/Equivalence_principle)
* [Gravity as Curvature (General Relativity)](https://en.wikipedia.org/wiki/General_relativity)
* [Einstein Ring](https://en.wikipedia.org/wiki/Einstein_ring)
* [Redshift and Cosmic Expansion](https://en.wikipedia.org/wiki/Redshift)
...
* [Bike Balancing and Countersteering](https://en.wikipedia.org/wiki/Countersteering)
...
* [Geiger-Nuttall Law](https://en.wikipedia.org/wiki/Geiger%E2%80%93Nuttall_law)

## Computer Science & Algorithms
* [P vs NP Problem](https://en.wikipedia.org/wiki/P_versus_NP_problem)
* [Fast Fourier Transform](https://en.wikipedia.org/wiki/Fast_Fourier_transform)
* [Conway's Game of Life](https://en.wikipedia.org/wiki/Conway%27s_Game_of_Life)
* [Analog Computers](https://en.wikipedia.org/wiki/Analog_computer)
...
* [Honeycomb Conjecture](https://en.wikipedia.org/wiki/Honeycomb_conjecture)
